    ...
    <div class="col-12 grid-margin">
        <div class="card">
            ...
            @endif
                ...
                <form class="form-sample" action="{{route('pegawai.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="foto" class="file-upload-default" id="foto-upload">
